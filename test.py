...
parser = argparse.ArgumentParser(description='LM2CNet for Monocular 3D Visual Grounding')
parser.add_argument('--config', default='configs/LM2CNet.yaml', help='settings of detection in yaml format')
...
def main():
    ...
    test_flag = True
    # build dataloader
    test_loader = build_dataloader(cfg['dataset'], test_flag)
